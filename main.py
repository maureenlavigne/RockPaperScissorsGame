...
# To see words appear slowly as if someone was typing them
...
# Function for calculating result (limited to console)
...
# First round: joke because no random function used
def jokeConsol():
...
def main():
    jokeConsol()
    # Second round with function, start of loop
    valid_answer = False
    draw = True
